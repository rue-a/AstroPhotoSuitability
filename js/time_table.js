...
function build_time_table(aggregated) {
    ...
    const svg_padding_left = 150;
    const svg_padding_top = 20;
    const cells_group = svg.append('g')
        .attr('transform', `translate(${svg_padding_left}, ${svg_padding_top})`)
    ...
    svg.selectAll("x-label")
        ...
        .attr('transform', function (d) {
            let x = ((parseInt(d.i)) * (cellSize + cellPadding)) + svg_padding_left - cellSize / 5;
